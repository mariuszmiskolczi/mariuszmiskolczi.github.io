(function ( $, x5engine ) {
	...
	s.siteId = '7CFFAA304CC72495C2AA880E412098B1';
	s.islocal = true;
	$.extend(true, s , {
		"imCart": {
			"slugToProductIdMap": {},
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: '4', path: 'captcha/imcpa_wvr.gif'},
				"1": { letter: 'E', path: 'captcha/imcpa_akm.gif'},
				"2": { letter: '7', path: 'captcha/imcpa_khv.gif'},
				"3": { letter: '5', path: 'captcha/imcpa_38u.gif'},
				"4": { letter: '5', path: 'captcha/imcpa_n7a.gif'},
				"5": { letter: 'H', path: 'captcha/imcpa_hh4.gif'},
				"6": { letter: '7', path: 'captcha/imcpa_g2g.gif'},
				"7": { letter: '7', path: 'captcha/imcpa_lud.gif'},
				"8": { letter: 'R', path: 'captcha/imcpa_zn3.gif'},
				"9": { letter: 'U', path: 'captcha/imcpa_cr7.gif'}
			}
		});
	}, false, 'first');
